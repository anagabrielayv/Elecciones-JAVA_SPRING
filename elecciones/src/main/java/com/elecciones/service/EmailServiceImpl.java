...
public class EmailServiceImpl implements IEmailService {
	...
	public boolean enviarEmailVoto(EmailBean emailBean) {
		...
		try {
			...
			String htmlMensaje = "<html>" +
                    "<head>" +
                    "<meta charset=\"utf-8\">" +
                    "<title>Su voto se ha registrado</title>"+
                    "</head>" +
                    ...
                    "</p>" +
                    "<p style=\"margin:20px 20px 20px; text-align:left; font-size:16px; line-height:22px; color:#000000; font-family: verdana\">" +
                    "Usted voto por el partido: " +emailBean.getPartido()+ 
                    "</p>" +
                    "<br>" +
                    "<p style=\"margin:20px 20px 20px; text-align:left; font-size:16px; line-height:22px; color:#000000; font-family: verdana\">" +
                    emailBean.getsEmailTo() + 
                    "</p>" +
                    "<br>" +
                    "<p style=\"margin:20px 20px 20px; text-align:left; font-size:16px; line-height:22px; color:#000000; font-family: verdana\">" +
